...
public class PageInfo {
	...
	private int pageLimit; // 하단에 보여질 페이징바의 페이지 목록 최대 개
	private int boardLimit; // 해당 페이지에 보여질 게시글의 최대 개수
	
	private int maxPage; // 가장 마지막 페이지 수(listCount, boardLimit을 가지고 구함)
	private int startPage; // 해당 페이징에 보여질 페이징바의 시작수 (pageLimit, currentPage를 가지고 구함)
	private int endPage; // 해당 페이징에 보여질 페이징바의 끝수 (startPage, pageLimit, maxPage를 가지고 구함)
